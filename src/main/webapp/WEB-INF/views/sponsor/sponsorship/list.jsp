...
<acme:list>
	...
	<acme:list-column code="sponsor.sponsorship.list.label.duration-start" path="durationStart" width="10%"/>	
	<acme:list-column code="sponsor.sponsorship.list.label.duration-end" path="durationEnd" width="10%"/>	
