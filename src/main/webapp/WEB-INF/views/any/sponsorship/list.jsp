...
<acme:list>
	...
	<acme:list-column code="any.sponsorship.list.label.duration-start" path="durationStart" width="10%"/>	
	<acme:list-column code="any.sponsorship.list.label.duration-end" path="durationEnd" width="10%"/>	
	...
	<acme:list-column code="any.sponsorship.list.label.email-contact" path="emailContact" width="10%"/>
