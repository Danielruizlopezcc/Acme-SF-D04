...
<acme:list>
	...
	<acme:list-column code="auditor.code-audit.list.label.proposed-corrective-actions" path="proposedCorrectiveActions" width="10%"/>
	<acme:list-column code="auditor.code-audit.list.label.link" path="link" width="10%"/>				
