...
public class AuditorAuditRecordsUpdateService extends AbstractService<Auditor, AuditRecords> {
	...
	public void authorise() {
		...
		auditRecords = this.repository.findOneAuditRecordsById(auditRecordsId);
		status = codeAudits != null && codeAudits.isDraftMode() && super.getRequest().getPrincipal().hasRole(codeAudits.getAuditor()) && auditRecords.getDraftMode();
